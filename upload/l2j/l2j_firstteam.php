...
//		22	=> "braslet",
	...
	"getAccountCharacters" => "
		SELECT characters.account_name, characters.obj_Id AS charID, characters.char_name, character_subclasses.level, characters.accesslevel, characters.lastAccess, characters.online, characters.onlinetime, char_templates.ClassName, clan_subpledges.name as clan_name 
		FROM `characters` 
		LEFT JOIN `character_subclasses` ON characters.obj_Id = character_subclasses.char_obj_id  AND character_subclasses.isBase='1'
		LEFT JOIN `char_templates` ON character_subclasses.class_id = char_templates.ClassId
		LEFT JOIN `clan_subpledges` ON characters.clanid = clan_subpledges.clan_id AND clan_subpledges.type='0'
	...
	"getTop" => "
		SELECT characters.char_name, character_subclasses.level, characters.sex, characters.pvpkills, characters.pkkills, characters.online, characters.onlinetime, char_templates.ClassName, clan_subpledges.name as clan_name, clan_subpledges.clan_id  
		FROM `characters`
		LEFT JOIN `character_subclasses` ON characters.obj_Id = character_subclasses.char_obj_id AND character_subclasses.isBase='1'
		LEFT JOIN `char_templates` ON character_subclasses.class_id = char_templates.ClassId
		LEFT JOIN `clan_subpledges` ON characters.clanid = clan_subpledges.clan_id AND clan_subpledges.type='0' 
	...
	"getRich" => "
		SELECT characters.char_name, character_subclasses.level, characters.sex, characters.online, characters.onlinetime, char_templates.ClassName, clan_subpledges.name as clan_name, clan_subpledges.clan_id, count 
		FROM `characters` 
		LEFT JOIN `character_subclasses` ON characters.obj_Id = character_subclasses.char_obj_id AND character_subclasses.isBase='1'
		LEFT JOIN `char_templates` ON character_subclasses.class_id = char_templates.ClassId 
		LEFT JOIN `clan_subpledges` ON characters.clanid = clan_subpledges.clan_id AND clan_subpledges.type='0'
